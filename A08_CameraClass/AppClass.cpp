...
void AppClass::Display(void)
{
	...
	//Render the cone
	m_pCone->Render(m_pCamera->GetProjection(false), m_pCamera->GetView(), IDENTITY_M4);

	//Render the cylinder
	m_pCylinder->Render(m_pCamera->GetProjection(false), m_pCamera->GetView(), glm::translate(IDENTITY_M4, REAXISZ * -3.0f));
