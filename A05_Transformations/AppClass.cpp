...
#pragma region YOUR CODE GOES HERE
	//Rotate Earth
	m_m4Earth = glm::rotate(m_fEarthTimer, vector3(0.0f, 1.0f, 0.0f));

	//Calculate the position of the Earth
	m_m4Earth = glm::translate(m_m4Earth, vector3(11.0f, 0.0f, 0.0f));

	//Rotate Earth on it's axis
	m_m4Earth = glm::rotate(m_m4Earth, m_fEarthTimer*360, vector3(0.0f, 0.0f, 1.0f));

	//Get The earth's position matrix with no rotations
	matrix4 EarthPos = IDENTITY_M4;
	EarthPos[3] = m_m4Earth[3];
	
	//Rotate Moon
	m_m4Moon = glm::rotate(EarthPos, static_cast<float>(m_fEarthTimer*12.857), vector3(0.0f, 0.0f, 1.0f));

	//Calculate the position of the Moon
	m_m4Moon = glm::translate(m_m4Moon, vector3(0.0f, 2.0f, 0.0f));
#pragma endregion
