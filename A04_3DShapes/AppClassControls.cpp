...
#pragma region Other Actions
	...
	ON_KEY_PRESS_RELEASE(F6, NULL, m_pPrimitive->GenerateCylinder(1.0f, 2.0f, 10, REBLUE));
	ON_KEY_PRESS_RELEASE(F7, NULL, m_pPrimitive->GenerateTube(1.0f, 0.7f, 2.0f, 10, REYELLOW));
